...
## Test baseline
Full `unittest discover` grew **318 → 480** tests, green each track (MCP +26, capability
assessment fixes, observe-then-replan +7, spreadsheet formulas +7, intrinsic math +13). Plus a standalone
